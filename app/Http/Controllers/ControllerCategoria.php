...
class ControllerCategoria extends Controller
{
     ...
     */
    public function adicionar(RequestCategoria $request)
    {

        //Atribuição em massa
        Categoria::create($request->input());

        return redirect()->action('ControllerCategoria@categorias');
    ...
    public function editar(RequestCategoria $request)
    {
